...
PATHTO=/home/lxiang/Software/SICER1.1
SICER=$PATHTO/SICER
...
echo "python $SICER/src/remove_redundant_reads.py -s $SPECIES -b $CONTROLDIR/$CONTROLBED -t $CONTROLTHRESHOLD -o $OUTPUTDIR/$FILTEREDCONTROLBED"
python $SICER/src/remove_redundant_reads.py -s $SPECIES -b $CONTROLDIR/$CONTROLBED -t $CONTROLTHRESHOLD -o $OUTPUTDIR/$FILTEREDCONTROLBED
