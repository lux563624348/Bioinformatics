...
OUTFILE=$READS-on-EligibleEntrezGenes_new.dat
...
python $EXEDIR/get_strandspecific_read_count_on_ExonsIntrons.py -f $READSDIR/$READFILEF -r $READSDIR/$READFILER -g $FRAGMENTSIZE -u $ANNOTATIONDIR/$ANNOTATION -o $OUTFILE -s hg19
