...
if test -f $OUTPUTDIR/$FILTEREDSAMPLEBED; then
...
if test -f $OUTPUTDIR/$FILTEREDCONTROLBED; then
...
if test -f $SUMMARY_DIR/$CONTROLSUMMARY; then
...
if test -f $SUMMARY_DIR/$NORMALIZEDCONTROLSUMMARY; then
