...
for index, chrmLabel in BD.genome.idx2label.iteritems():
    ...
    f1_df.to_csv('fit-hi-c/WT_CD8_marginal_contactCounts.txt', index=None, header=None, sep='\t', mode='a')
...
for index, chrmLabel in BD.genome.idx2label.iteritems():
    ...
    f2_df.to_csv('fit-hi-c/WT_CD8_contactCounts.txt', sep='\t', index=None, header=None, mode='a')
...
bias_df.to_csv('fit-hi-c/WT_CD8_ICE_bias.txt', index=None, header=None, sep='\t')

#BD = highResBinnedData.HiResHiC(genome_db, 10000, 'WT_CD8_heatmap-res-10K-IC.hdf5', mode='r+')
...
for index, chrmLabel in BD.genome.idx2label.iteritems():
    ...
    Juicebox_df.to_csv('Juicebox/WT_CD8_Juicebox_input.txt', sep='\t', index=None, header=None, mode='a')
