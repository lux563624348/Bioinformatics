...
case ${SPECIES} in
	...
	"GRCh38")
	echo "Reference SPECIES is ${SPECIES}"
	local GTFFILE=/slst/home/fanyh/Annotation/GRCh38_GENCODE_rmsk_TE.gtf
#	local GTFFILE=/home/shared_data/Annotation/gtf_files/TE_GFT/GRCh38_GENCODE_rmsk_TE.gtf
	local INDEXS=/slst/home/fanyh/Annotation/hisat2_index/GRCh38/genome_rep
...
#### That is, if -k 2 is specified, HISAT2 will search for at most 2 distinct alignments. 
