...
mount -t cifs -o username=$CURRENT_USER,password=$password,uid=$THE_USER,gid=$THE_GROUP,dir_mode=0700,file_mode=0600 "//cloud.ccas.gwu.edu/Research" /home/$SUDO_USER/cloud_research
