...
__RAW_DATA_PATH_DIR="/mnt/d/bioproject/Nanping/atac-seq"
__Files_Name=["Spl1_CD4_old_peaks.xlsx",
"Spl1_CD8_old_peaks.xlsx",
"Spl2_CD4_young_j_peaks.xlsx",
"Spl2_CD8_young_j_peaks.xlsx",
"Spl3_CD4_young_c_peaks.xlsx",
"Spl3_CD8_young_c_peaks.xlsx",
"Thy1_CD8_old_c_peaks.xlsx",
"Thy2_CD4_old_c_peaks.xlsx",
"Thy2_CD4_young_j_peaks.xlsx",
"Thy2_CD8_young_j_peaks.xlsx",
"Thy_CD4_young_peaks.xlsx",
"Thy_CD8_young_peaks.xlsx"]
#__Files_Name=["test"]
...
def main():
	...
	for Fname in __Files_Name:
		...
		print File_Path
		df1=pd.read_excel(File_Path, sheetname=0, usecols=[0,1,2,5,8], convert_float=True, header=0)	
