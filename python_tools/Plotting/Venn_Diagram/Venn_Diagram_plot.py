...
def main():
	...
	A_solo=df1[ConA].value_counts()[1]-AB_com-AC_com-center
	B_solo=df1[ConB].value_counts()[1]-AB_com-BC_com-center
	C_solo=df1[ConC].value_counts()[1]-AC_com-BC_com-center
